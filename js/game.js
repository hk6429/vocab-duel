...
const VDGame = (() => {
  ...
  const TITLES = ['字鬥學徒', '見習字使', '字鬥劍客', '字鬥遊俠', '字鬥豪傑', '字鬥宗師', '字鬥聖手', '字鬥賢者', '字鬥仙師', '字鬥神帝',
    ...
    // 21–100：等級無上限（xp 公式本身不封頂），稱號補到 Lv100，避免高等級玩家卡在同一稱號不再更新
    '字鬥無極', '字鬥太乙', '字鬥太玄', '字鬥混元', '字鬥鴻蒙', '字鬥開天', '字鬥闢地', '字鬥主宰', '字鬥至尊', '字鬥無上',
    '字鬥元始', '字鬥太初', '字鬥太上', '字鬥玄一', '字鬥玄聖', '字鬥玄尊', '字鬥玄帝', '字鬥永恆', '字鬥不朽', '字鬥不滅',
    '字鬥無疆', '字鬥無涯', '字鬥無量', '字鬥萬古', '字鬥千古', '字鬥亙古', '字鬥絕世', '字鬥蓋世', '字鬥曠世', '字鬥曠古',
    '字鬥青龍', '字鬥白虎', '字鬥朱雀', '字鬥玄武', '字鬥麒麟', '字鬥鳳凰', '字鬥龍神', '字鬥鯤鵬', '字鬥紫微', '字鬥天樞',
    '字鬥天璇', '字鬥天璣', '字鬥天權', '字鬥玉衡', '字鬥開陽', '字鬥搖光', '字鬥九天', '字鬥九霄', '字鬥星辰', '字鬥星海',
    '字鬥宇宙', '字鬥寰宇', '字鬥乾坤', '字鬥開創', '字鬥開闢', '字鬥執掌', '字鬥掌控', '字鬥創世', '字鬥主神', '字鬥真神',
    '字鬥戰神', '字鬥戰帝', '字鬥戰聖', '字鬥戰尊', '字鬥戰皇', '字鬥萬王', '字鬥諸天', '字鬥萬界', '字鬥時空', '字鬥太虛',
    '字鬥混沌', '字鬥造物', '字鬥極道', '字鬥極天', '字鬥極尊', '字鬥獨尊', '字鬥唯一', '字鬥終極', '字鬥巔峰', '字鬥無雙'];
  const AVATARS = ['🦸', '🥷', '🧙', '🦉', '🐉', '🦊', '🐯', '🦅', '🐺', '🦁', '👑', '⚔️'];
